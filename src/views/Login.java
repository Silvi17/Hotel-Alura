...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/imagenes/nombre-hotel.png")));
		setResizable(false);
		setUndecorated(true);
		...
		panel_1.setBackground(new Color(52, 142, 145));
		panel_1.setBounds(484, 0, 304, 527);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel imgHotel = new JLabel("");
		imgHotel.setBounds(79, 0, 304, 538);
		panel_1.add(imgHotel);
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/nombre-hotel.png")));
		...
		btnexit.setBackground(new Color(33, 54, 53));
		...
		separator.setForeground(new Color(33, 54, 53));
		separator.setBackground(new Color(33, 54, 53));
		separator.setBounds(65, 292, 324, 2);
		panel.add(separator);
		
		JLabel labelTitulo = new JLabel("INICIAR SESIÓN");
		labelTitulo.setForeground(new Color(33, 54, 53));
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(65, 156, 295, 26);
		panel.add(labelTitulo);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBackground(new Color(33, 54, 53));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				btnLogin.setBackground(new Color(33, 54, 53));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				Login();
		...
		JLabel labelTitulo_1 = new JLabel("Ocean Palace");
		labelTitulo_1.setForeground(new Color(33, 54, 53));
		labelTitulo_1.setFont(new Font("Dialog", Font.PLAIN, 26));
		labelTitulo_1.setBounds(65, 87, 295, 26);
		panel.add(labelTitulo_1);
	}
	
	private void Login() {
		 String Usuario= "nala";
	     String Contraseña="nala";
