...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		modeloH.addColumn("Numero de Huésped");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) { // El usuario al pasar el mouse por el botón este cambiará de color
				btnexit.setBackground(Color.red);
				labelExit.setForeground(Color.white);
			}

			@Override
			public void mouseExited(MouseEvent e) { // El usuario al quitar el mouse por el botón este volverá al estado
													// original
...
//
								...
								}, () -> JOptionPane.showMessageDialog(contentPane, "Por favor, elije un ítem"));
